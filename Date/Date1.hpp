 ...
 * serves as an example of a simple class. Additional C++ features are presented in the enhanced
 * versions of this class. See Date2.hpp, Date3.hpp, etc.
 */

#ifndef DATE_HPP
#define DATE_HPP

// BP: Include *only* the header files that are needed to define the interface to this class.
#include <iosfwd>       // Needed to declare references to iostream objects.
#include <stdexcept>    // Needed for standard exception classes.
#include <string>
...
namespace vtsu {
     ...
     * 
     * \todo: The additional string format for input is not yet implemented.
     */
    class Date {
    public:
    ...
    private:
        ...
        // Private Methods
        // BP: Helper methods like these should be private methods *only* if they need access to
        // the private members of the class; otherwise they should be defined in the
        // implementation file.
